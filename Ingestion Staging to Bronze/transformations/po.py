...
volume_path=f'/Volumes/{catalog_name}/staging/purchase_order'
...
@dlt.view(name="po_text_processed")
def po_text_processed():
    return dlt.read_stream("raw_po_binary") \
