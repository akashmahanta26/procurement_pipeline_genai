...
volume_path=f'/Volumes/{catalog_name}/staging/invoice'
...
@dlt.view(name="invoice_text_processed")
def invoice_text_processed():
    return (
        dlt.read_stream("raw_invoice_binary")
